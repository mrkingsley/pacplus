...
<head>
  ...
  <!---------extra link for more effectiveness----------------->
...
<body class="">
    ...
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="">
              <i class="material-icons">sorting</i>
              <p>Outstandings</p>
            </a>
          </li>
          <li class="nav-item">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Purchases</a>
          </div>
                ...
                <div class="table-responsive">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th></th>
                            <th class="text-success"><span>&#8358;</span>{{$purchase->sum('amount_paid')  - $purchase->sum('balance')}}</th>
                            <th></th>
                            <th></th>
                            <th ></th>
                        </tr>
                    ...
                    <td><span>&#8358;</span>{{ $purchase->amount_paid}}</td>
                    <td class="text-danger"><span>&#8358;</span>{{ $purchase->balance}}</td>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="#" target="_blank">KINGSWAY</a> Accounting made easy.
          </div>
        </div>
      </footer>
    </div>
  ...
  <div class="fixed-plugin">
   ...
   <!---------extra  script link for more effectiveness-----------------
