            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('unite_price')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="unite_price" class="form-control" value="{{ old('unite_price') }}" placeholder="price for each single goods">
                    ...
                    <div class="form-group {{ $errors->has('total_product')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="total_product" class="form-control" value="{{ old('total_product') }}" placeholder="total quantity of good purchased">
