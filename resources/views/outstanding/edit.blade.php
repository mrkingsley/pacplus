    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box">
                ...
                <form class="form-horizontal" action="{{route('outstanding.update', $outstanding->id)}}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('put')
                        <div class="form-group {{ $errors->has('client')? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                            <select class="form-control" placeholder="Select Product, " name="client">
                            <option value="{{$outstanding->client}}">{{$outstanding->client}}</option>
                    ...
                    <div class="form-group {{ $errors->has('purchase_amount')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" name="purchase_amount" class="form-control" value="{{ old('purchase_amount') ? old('purchase_amount') : $outstanding->purchase_amount}}" placeholder="Enter Purchase amount">
                    ...
                    <div class="form-group {{ $errors->has('payment')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" name="payment" class="form-control" value="{{ old('payment') ?  old('payment') : $outstanding->payment}}" placeholder="Enter amount paid">
                    ...
                    <div class="form-group {{ $errors->has('method')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <select class="form-control show-tick" name="method" id="type">
                                <option value="{{$outstanding->method}}" disabled selected>{{$outstanding->method}}</option>
