...
class RepairProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('repair.repair_product_index', compact('pageTitle'));
    }
    ...
    public function repairInvoiceData()
    {
        ...
        if($user->isSuperAdmin()) {
            ...
            $invoices = Repair_invoice::where('user_id', $user->id)->select('id', 'product', 'user_id','total_price', 'customer_name', 'created_at')->orderBy('id', 'desc')->with('user');
    ...
    {
        $pageTitle = 'Repair product index';
        return view('repair.completed_repair_product_index', compact('pageTitle'));
    }
    ...
    public function completedRepairInvoiceData()
    {
        ...
        if($user->isSuperAdmin()) {
            $invoices = Repair_invoice::select('id', 'product', 'user_id', 'invoice_id', 'total_price', 'customer_name', 'created_at')->where('status','completed')->orderBy('id', 'desc')->with('shop', 'user');
            ...
            $invoices = Repair_invoice::where('user_id', $user->id)->select('id', 'product', 'user_id', 'invoice_id', 'total_price', 'customer_name', 'created_at')->where('status','completed')->orderBy('id', 'desc')->with('shop', 'user');
    ...
    public function create()
    {
        ...
        return view('repair.new_repair_product', compact('pageTitle', 'products'));
    }
